...
from visualisation_performances_sportives.analyse_sportive.bilan import (
    construire_page_bilan,
)
...
def test_construire_page_bilan():
    ...
    assert "COUNTA(Data!A2:A150)" in ws["C5"].value, (
        "La formule Excel générée est incorrecte."
    )
