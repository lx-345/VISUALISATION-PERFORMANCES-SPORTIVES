...
def get_base_styles():
    ...
    """
    couleur_fond = PatternFill(start_color="333333", end_color="333333", fill_type="solid")
...
def appliquer_theme_global(ws):
    ...
    """
    fond_sombre = PatternFill(start_color="1E1E1E", end_color="1E1E1E", fill_type="solid")
